...
const Community: React.FC<CommunityProps> = ({ isDark }) => {
  ...
  return (
    <section id="community" className={`py-20 px-4 relative overflow-hidden transition-all duration-500 ${isDark ? 'bg-slate-900' : 'bg-gray-50'}`}>
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div className={`p-8 rounded-2xl ${isDark ? 'bg-slate-800' : 'bg-white'} shadow-xl`}>
            ...
            {/* Room Battle Preview */}
            <div className={`mt-8 p-6 rounded-xl border-2 border-dashed ${isDark ? 'border-purple-500/30 bg-purple-500/5' : 'border-purple-500/30 bg-purple-50'}`}>
              ...
              <button className="w-full bg-gradient-to-r from-purple-500 to-pink-600 hover:from-purple-600 hover:to-pink-700 text-white py-2 px-4 rounded-lg font-semibold transition-all duration-300 hover:scale-105">
                Join Battle
              </button>
            </div>
          </div>
